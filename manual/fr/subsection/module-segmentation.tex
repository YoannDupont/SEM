...
\begin{itemize}
    \item[] \textbf{description}
        \begin{itemize}
            \item[] Prend un fichier texte linéaire et segmente le texte en phrase et tokens et donne un fichier vectorisé.
        \end{itemize}
    \item[] \textbf{arguments}
        \begin{itemize}
            \item[] infile : fichier
                \begin{itemize}
                    \item[] le fichier d'entrée. Format texte brut.
                \end{itemize}
            \item[] outfile : fichier
                \begin{itemize}
                    \item[] le fichier de sortie. Format vectorisé.
                \end{itemize}
        \end{itemize}
    \item[] \textbf{options}
        \begin{itemize}
