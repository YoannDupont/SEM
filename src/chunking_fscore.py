...
def chunking_fscore(infile,
                    reference_column=-2, tagging_column=-1,
...
if __name__ == "__main__":
    ...
    chunking_fscore(args.infile,
                    reference_column=args.reference_column, tagging_column=args.tagging_column,
                    ienc=args.ienc or args.enc, oenc=args.ienc or args.enc,
